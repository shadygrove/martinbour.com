(function($) {
	...
	$(document).ready(function() { 
		...
		var token = igConfig.token, // learn how to obtain it below
	        userid = igConfig.self, // User ID - get it in source HTML of your Instagram profile or look at the next example :)
	        num_photos = igConfig.count; // how much photos do you want to get
